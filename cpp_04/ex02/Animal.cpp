...
//now that the funciton is fully virtual and we cannot create an instacne of ANimal
//we can keep or delete the implementation. Keeping it will allow children to
//call this parent function explicitly
